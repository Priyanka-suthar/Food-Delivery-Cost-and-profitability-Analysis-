...
import seaborn as sns # visualizing the comparison
from datetime import datetime # Import the necessary module


# Read the CSV file
food_orders = pd.read_csv("C:/Users/paris/Downloads/food_orders_new_delhi.csv")
...
def extract_discount(discount_str):
    if isinstance(discount_str, str):  # Check if the discount_str is a string
        ...
        return 0.0  # Return 0.0 if the discount_str is not a string
